...
public class UserlookupTest {
	...
	/**
	 * A class variable that is UserAccount array called people
	 */
	public static final UserAccount[] people = new UserAccount[10];

	/**
	 * A class variable that is of type UserAccount called user account
	 */
	...
	/**
	 * Test method for {@link user.Userlookup#getUseraccount(java.lang.String)}.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link user.Userlookup#getUseraccount(java.lang.String)}.
	 */
